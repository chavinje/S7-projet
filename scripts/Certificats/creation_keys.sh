...
repertoire_cle="/home/vagrant/cle_certificat"
...
sudo mkdir /home/vagrant/cle_certificat

#Generer une cle ssl
cd /home/vagrant/cle_certificat
...
openssl req -new -key $key_name -out $cert_sign_request -subj "/C=FR/ST=France/L=Angers/O=ESEO/OU=ESEO/CN=basketsite11.com"
